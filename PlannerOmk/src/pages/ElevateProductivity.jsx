                ...
                <div className="flex flex-row">
                    <div className=" w-1/5 hidden lg:block">
                        <nav className=" sticky top-28 h-auto">
                            ...
                            <ul>
                                <li className="mb-1"><Link className="text-lg text-slate-700 hover:text-black hover:underline " to={'/blog/elevate-your-productivity-with-omkplanner#discover'}><img src={Lines} alt="" className="h-6 opacity-50 -rotate-45 inline mr-1 hover:opacity-100" /> Discovering OMK : A Simple Solution</Link></li>
                                <li className="mb-1"><Link className="text-lg text-slate-700 hover:text-black hover:underline " to={'/blog/elevate-your-productivity-with-omkplanner#productivity'}><img src={Lines} alt="" className="h-6 opacity-50 -rotate-45 inline mr-1 hover:opacity-100" />OMK : A Fresh Take on Productivity</Link></li>
                                <li className="mb-1"><Link className="text-lg text-slate-700 hover:text-black hover:underline " to={'/blog/elevate-your-productivity-with-omkplanner#omk-great'}><img src={Lines} alt="" className="h-6 opacity-50 -rotate-45 inline mr-1 hover:opacity-100" />What Makes OMK  Great?</Link></li>
                                <li className="mb-1"><Link className="text-lg text-slate-700 hover:text-black hover:underline " to={'/blog/elevate-your-productivity-with-omkplanner#more'}><img src={Lines} alt="" className="h-6 opacity-50 -rotate-45 inline mr-1 hover:opacity-100" />More to Explore with OMK </Link></li>
                                <li className="mb-1"><Link className="text-lg text-slate-700 hover:text-black hover:underline " to={'/blog/elevate-your-productivity-with-omkplanner#wrapping'}><img src={Lines} alt="" className="h-6 opacity-50 -rotate-45 inline mr-1 hover:opacity-100" />Wrapping Up</Link></li>
                            </ul>
                        </nav>
                    </div>
